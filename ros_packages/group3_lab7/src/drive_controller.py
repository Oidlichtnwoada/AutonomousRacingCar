...
from group3_lab7.cfg import drive_controller_Config as ConfigType
...
class DriveController:
    ...
    def __init__(self):
        ...
        #heading_topic = '/motion_planner/steering_angle' # vehicle heading setpoint (units: rad) # <--- use this for debugging!
        heading_topic = '/drive_controller/steering_angle' # vehicle heading setpoint (units: rad)
...
def main(args):
    ...
    reactive_driving_controller = DriveController()
    rospy.sleep(0.1)
    rospy.spin()
