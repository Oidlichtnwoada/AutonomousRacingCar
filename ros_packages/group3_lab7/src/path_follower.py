...
from group3_lab7.cfg import path_tracker_Config as Configuration
...
class PathTracker:
    ...
    def __init__(self):
        ...
        self.tracked_path_sub = rospy.Subscriber("/path_tracker/tracked_path", Path, self.tracked_path_callback)
        ...
        self.goal_pub = rospy.Publisher('/path_tracker/goal', PoseStamped, queue_size=1000) # for RViz
        self.track_arc_pub = rospy.Publisher('/path_tracker/track_arc', Marker, queue_size=1000) # for RViz
        self.commanded_heading_pub = rospy.Publisher('/path_tracker/commanded_heading', PoseStamped, queue_size=1000) # for RViz
        self.commanded_heading_angle_pub = rospy.Publisher('/path_tracker/commanded_heading_angle', Float32, queue_size=1000) # for the drive controller
    ...
    def reconfigure(self, config, level):
        rospy.loginfo("""[path_tracker] reconfigure request: {lookahead_distance}""".format(**config))
