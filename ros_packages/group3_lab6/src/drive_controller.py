...
from group3_lab6.cfg import drive_controller_paramsConfig as ConfigType
...
class DriveController:
    ...
    def __init__(self):
        ...
        heading_topic = '/pure_pursuit/commanded_heading_angle' # vehicle heading setpoint (units: rad)
